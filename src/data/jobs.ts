...
const jobs: IJob[] = [
	{
		slug: 'clickup',
		displayName: 'ClickUp',
		industries: ['AI', 'Productivity', 'SaaS'],
		platforms: ['Web'],
		link: 'https://clickup.com',
		description: 'The everything app for work — tasks, docs, goals, chat, and time tracking in one platform',
		logoUrl: '/images/logos/ClickUp/Logomark-gradient.svg',
		bgUrl: '/images/logos/ClickUp/Logo-gradient-on-dark.svg',
		bgColor: '#2E1A6E',
		role: 'Senior Software Engineer',
		roleSummary: "At ClickUp I work on the frontend of the Project Management and Time Management experiences — the parts of the product teams live in every day.<br /><br />ClickUp's hierarchy (Workspaces, Spaces, Folders, Lists, Tasks, and Subtasks) means nearly every surface has to stay fast and consistent while rendering deeply nested, highly customizable, collaboratively edited data.<br /><br />I collaborate closely with design, product, and backend partners to ship features across task views, time tracking, and the reporting surfaces that tie them together.",
		timeline: '2026 — Present',
		projects: [
			{
				slug: 'project-management',
				displayName: 'Project Management',
				link: 'https://clickup.com/features/project-management',
				description: "ClickUp's project management surfaces let teams plan and track work across List, Board, Calendar, Gantt, Table, and Timeline views, with custom fields, statuses, dependencies, sprints, and automations layered on top. I build and maintain frontend features across these views, focused on rendering large, deeply nested task hierarchies quickly and keeping collaborative state in sync across sessions.",
				achievements: [],
				features: [
					'Task views and layouts backed by virtualized rendering for large data sets',
					'Custom fields, statuses, and dependency management UI',
					'Real-time collaborative updates across concurrent sessions',
					'Filtering, grouping, and saved view configuration',
				],
			...
			},
			{
				...
				link: 'https://clickup.com/features/project-time-tracking',
				description: 'ClickUp Time Management covers native time tracking, time estimates, timesheets, and billable time — plus the calendar and workload surfaces teams use to plan capacity. I work on the frontend for these features, from the timer controls embedded throughout the app to the timesheet and reporting views where that data gets reviewed and approved.',
				achievements: [],
				features: [
					'Global and per-task timer controls with manual entry and editing',
					'Timesheets, billable time, and approval workflows',
					'Time estimates and rollups across task hierarchies',
					'Calendar and workload views for capacity planning',
				],
